...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('username, password, fullname, office, tel, email, role, lastlogin', 'length', 'max'=>255),
			array('amp', 'length', 'max'=>4),
			array('ispermission', 'length', 'max'=>5),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('username, password, fullname, amp, office, tel, email, role, lastlogin, countlogin, ispermission', 'safe', 'on'=>'search'),
		);
	}
