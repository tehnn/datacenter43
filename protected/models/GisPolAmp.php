...
/**
 * This is the model class for table "gis_pol_amp".
 *
 * The followings are the available columns in table 'gis_pol_amp':
 * @property integer $id
 * @property string $X
 * @property string $Y
 ...
 */
class GisPolAmp extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, X, Y, POLYTYPE, PROV_CODE, AMP_CODE, PROV_NAMT, PROV_NAME, AMP_NAMT, AMP_NAME', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return GisPolAmp the static model class
	 */
